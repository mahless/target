...
const TrackingPage = () => {
 ...
 <h2 className="text-white text-2xl font-black mb-4">{error || 'عذراً، المعاملة غير موجودة'}</h2>
 ...
 <h1 className="text-lg md:text-xl font-black text-[#01404E]">تارجت للخدمات الحكومية</h1>
 </div>
 ...
 <div>
 <p className="text-[9px] md:text-[10px] font-black text-[#01404E]/40 uppercase mb-0.5">اسم العميل</p>
 ...
 <div>
 <p className="text-[9px] md:text-[10px] font-black text-[#01404E]/40 uppercase mb-0.5">نوع الخدمة</p>
 ...
 <div>
 <p className="text-[9px] md:text-[10px] font-black text-[#01404E]/40 uppercase mb-0.5">التاريخ</p>
