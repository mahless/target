          ...
          <form onSubmit={handleSubmit} className="space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3 p-1 bg-white/40 rounded-3xl border border-[#01404E]/5 shadow-sm">
              <div className="md:col-span-2">
                <label className="block text-[10px] md:text-xs font-black text-[#01404E]/60 uppercase tracking-widest mb-1 mr-1">الاسم بالكامل {!isOtherService && <span className="text-red-500">*</span>}</label>
              ...
              <div className="md:col-span-1">
                <label className="block text-[10px] md:text-xs font-black text-[#01404E]/60 uppercase tracking-widest mb-1 mr-1">الرقم القومي {(!isOtherService && !isSellingForm) && <span className="text-red-500">*</span>}</label>
              ...
              <div className="md:col-span-1">
                <label className="block text-[10px] md:text-xs font-black text-[#01404E]/60 uppercase tracking-widest mb-1 mr-1">رقم الهاتف {(!isOtherService && !isSellingForm) && <span className="text-red-500">*</span>}</label>
