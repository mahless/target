  ...
  return (
    <div className="max-w-4xl mx-auto p-3 md:p-5">
      <div className={`bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden transition-opacity ${isSubmitting ? 'opacity-50 pointer-events-none' : ''}`}>
        <div className="bg-blue-800 p-4 text-white flex justify-between items-center shadow-lg">
          ...
          <div className="relative">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pr-12 pl-4 py-2.5 border-2 border-blue-600 rounded-2xl bg-white shadow-inner text-black font-black placeholder-gray-400 focus:ring-4 focus:ring-blue-50 outline-none transition-all"
              />
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded-2xl space-y-3 border border-gray-100 shadow-inner">
              <div className="flex items-center gap-3">
                ...
                <label htmlFor="tpCheck" className="text-sm font-black text-gray-800 cursor-pointer select-none">إدراج مكتب خارجي في المعاملة</label>
              </div>
              {hasThirdParty && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 animate-fadeIn">
                  <div>
            ...
            <button
              ...
              className={`w-full bg-blue-800 hover:bg-blue-900 text-white font-black py-3.5 rounded-2xl shadow-xl shadow-blue-900/20 flex items-center justify-center gap-3 transition-all active:scale-[0.98] ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
            >
