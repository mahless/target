...
const Reports: React.FC<ReportsProps> = ({
 ...
 <h2 className="text-xl font-black">التقارير التحليلية</h2>
 {userRole === 'مدير' && (
 <button
 ...
 <p className="text-white/40 text-[10px] font-black ] uppercase mt-0.5">متابعة الأداء والتدفقات النقدية</p>
 </div>
 </div>
 ...
 <div>
 <h3 className="text-xl font-black text-[#01404E] whitespace-nowrap">تخصيص البحث والفترة</h3>
 <p className="text-[10px] text-[#036564] font-black uppercase ] mt-1">تصفية النتائج</p>
 </div>
 </div>
 ...
 <span className="text-[10px] whitespace-nowrap uppercase">{isSyncing ? 'جاري السحب' : 'تحديث البيانات'}</span>
 </button>
 </div>
 </div>
 ...
 <span className="bg-[#00A6A6]/10 text-[#00A6A6] px-2 py-0.5 rounded-lg text-[9px] font-black uppercase w-fit">{e.serviceType}</span>
 </div>
 </td>
 ...
 <td className="py-3 px-8 text-center text-[#01404E]/40 text-[11px] font-black">{e.entryDate}</td>
 </tr>
 ))
 )}
 </tbody>
 ...
 <table className="w-full border-collapse">
 <thead className="sticky top-0 z-20">
 <tr className="bg-red-900 text-white/50 text-xs font-black ] uppercase border-b border-white/5">
 ...
 <td className="py-3 px-6 text-center">
 <span className="text-2xl font-black text-red-600">-{ex.amount.toLocaleString()}<span className="text-[10px] mr-1 opacity-50 uppercase">ج.م</span></span>
 </td>
 <td className="py-3 px-6 text-center">
 ...
 <td className="py-3 px-8 text-center text-red-900/40 text-[11px] font-black">{ex.date}</td>
 </tr>
 ))
 )}
 </tbody>
