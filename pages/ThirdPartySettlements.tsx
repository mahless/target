...
const ThirdPartySettlements: React.FC<ThirdPartySettlementsProps> = ({
 ...
 <div>
 <h3 className="text-xl font-black text-[#01404E] whitespace-nowrap">بحث في التسويات</h3>
 ...
 <td className="py-2.5 px-6 text-center">
 <div className="flex flex-col items-center gap-0.5 group-hover:scale-110 transition-transform">
 <span className="text-sm md:text-base font-black text-blue-600">{entry.thirdPartyCost?.toLocaleString()}<span className="text-[9px] md:text-[10px] mr-1 opacity-50 uppercase">ج.م</span></span>
 </div>
 </td>
