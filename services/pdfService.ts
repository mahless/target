        ...
        <div class="header">
          ...
          <div style="display: flex; justify-content: space-between; align-items: flex-end;">
            <div class="meta-info">
              ...
              <div class="meta-item">وقت الطباعة: ${escapeHtml(new Date().toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' }))}</div>
      ...
      : `<img src="./assets/qr-code.jpg" style="width: 100%; height: 100%; object-fit: contain;" alt="QR" id="qrImg" />`
        ...
        <div class="footer">
          <div class="totals-section">
            ...
            <div class="total-item"><span class="total-label">المدفوع</span><span class="total-value" style="color: #000;">${escapeHtml(entry.amountPaid)} EGP</span></div>
            <div class="total-item"><span class="total-label">المتبقي</span><span class="total-value" style="color: #000;">${escapeHtml(entry.remainingAmount)} EGP</span></div>
          </div>
          ...
          <div class="contact-info">
            <div class="footer-line" style="display: flex; justify-content: space-between; align-items: flex-start; width: 100%;">
              ...
              <div style="display: flex; flex-direction: column; gap: 4px; direction: ltr; padding-top: 2px;">
                <div style="font-size: 7pt; font-weight: 900; margin-bottom: 2px; color: #000; text-align: left;">Administration:</div>
                <div style="display: flex; align-items: center; gap: 6px;">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 1 1-7.6-11.7.9.9 0 1 1 0 1.8 6.7 6.7 0 1 0 6 9.2 6.7 6.7 0 0 0 .1-6.7.9.9 0 1 1 1.6-.8Z"/></svg>
                  <span style="font-family: sans-serif; font-weight: 900;">01005757346</span>
                </div>
                <div style="display: flex; align-items: center; gap: 6px;">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
