...
export const ModalProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <ModalContext.Provider value={{ showModal, hideModal, showQuickStatus }}>
      {children}
      {quickStatus && (
      ...
      {modal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[100] flex items-center justify-center p-4 animate-scaleIn">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 border border-white/20 relative overflow-hidden">
            ...
            <div className="text-gray-600 mb-8 font-bold leading-relaxed text-right">
              {modal.content}
            </div>
