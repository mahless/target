        ...
        <div className="space-y-2 text-right">
            <div className="grid grid-cols-3 gap-1.5">
                ...
                <div className="bg-gray-50 p-1.5 rounded-xl border border-gray-100">
                    <span className="text-[9px] text-gray-400 font-black block mb-0.5 uppercase tracking-tighter">العميل</span>
                    <p className="font-black text-gray-800 text-[11px] truncate">{entry.clientName}</p>
                </div>
                <div className="bg-gray-50 p-1.5 rounded-xl border border-gray-100">
                    <span className="text-[9px] text-gray-400 font-black block mb-0.5 uppercase tracking-tighter">الرقم القومي</span>
                    <p className="font-black text-gray-800 text-[11px]">{toEnglishDigits(String(entry.nationalId))}</p>
                </div>
                <div className="bg-gray-50 p-1.5 rounded-xl border border-gray-100">
                    <span className="text-[9px] text-gray-400 font-black block mb-0.5 uppercase tracking-tighter">رقم الهاتف</span>
                    <p className="font-black text-gray-800 text-[11px]">{toEnglishDigits(String(entry.phoneNumber || '-'))}</p>
                </div>

                {/* Row 2 */}
                <div className="bg-gray-50 p-1.5 rounded-xl border border-gray-100">
                    <span className="text-[9px] text-gray-400 font-black block mb-0.5 uppercase tracking-tighter">نوع الخدمة</span>
                    <p className="font-black text-[#01404E] text-[11px] truncate">{entry.serviceType}</p>
                </div>
                <div className="bg-gray-50 p-1.5 rounded-xl border border-gray-100">
                    <span className="text-[9px] text-gray-400 font-black block mb-0.5 uppercase tracking-tighter">السرعة</span>
                ...
                <div className="bg-[#00A6A6]/5 p-1.5 rounded-xl border border-[#00A6A6]/10">
                    <span className="text-[9px] text-[#00A6A6] font-black block mb-0.5 uppercase tracking-tighter">التكلفة الإجمالية</span>
                ...
                <div className="bg-emerald-50 p-1.5 rounded-xl border border-emerald-100">
                    <span className="text-[9px] text-emerald-600 font-black block mb-0.5 uppercase tracking-tighter">المدفوع</span>
                ...
                <div className="bg-red-50 p-1.5 rounded-xl border border-red-100">
                    <span className="text-[9px] text-red-600 font-black block mb-0.5 uppercase tracking-tighter">المتبقي</span>
                ...
                {/* Row 4 */}
                <div className="bg-gray-50 p-1.5 rounded-xl border border-gray-100">
                    <span className="text-[9px] text-gray-400 font-black block mb-0.5 uppercase tracking-tighter">الموظف المسؤول</span>
                    <p className="font-black text-gray-800 text-[11px] truncate">{entry.recordedBy}</p>
                </div>
                <div className="bg-gray-50 p-1.5 rounded-xl border border-gray-100">
                    <span className="text-[9px] text-gray-400 font-black block mb-0.5 uppercase tracking-tighter">تاريخ العملية</span>
                    <p className="font-black text-gray-800 text-[11px] tracking-tighter">{entry.entryDate}</p>
                </div>
                <div className="bg-gray-50 p-1.5 rounded-xl border border-gray-100">
                    <span className="text-[9px] text-gray-400 font-black block mb-0.5 uppercase tracking-tighter">الوقت</span>
                ...
                <div className="col-span-1 bg-gray-50 p-1.5 rounded-xl border border-gray-100">
                    <span className="text-[9px] text-gray-400 font-black block mb-0.5 uppercase tracking-tighter">رقم أمر الشغل</span>
                    <p className="font-black text-blue-800 text-[11px]">{entry.workOrderNumber || 'لم يُحدد'}</p>
                </div>
                <div className="col-span-1 bg-gray-50 p-1.5 rounded-xl border border-gray-100">
                    <span className="text-[9px] text-gray-400 font-black block mb-0.5 uppercase tracking-tighter">حالة التتبع</span>
                ...
                <div className="col-span-1 bg-gray-50 p-1.5 rounded-xl border border-gray-100">
                    <span className="text-[9px] text-gray-400 font-black block mb-0.5 uppercase tracking-tighter">ملاحظات</span>
                    <p className="font-bold text-gray-600 text-[10px] truncate">{entry.notes || '-'}</p>
                </div>

                {/* Full Width Notes (if long) */}
                {entry.notes && entry.notes.length > 30 && (
                    <div className="col-span-3 bg-gray-50/50 p-1.5 rounded-xl border border-gray-100 -mt-0.5">
                        <span className="text-[9px] text-gray-400 font-black block mb-0.5">تفاصيل الملاحظات</span>
