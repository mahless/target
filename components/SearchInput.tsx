...
const SearchInput: React.FC<SearchInputProps> = ({
 ...
 className="w-full pr-10 pl-9 py-2 text-xs rounded-xl bg-white shadow-inner border-2 border-[#00A6A6] text-black font-black focus:border-[#00A6A6] focus:ring-4 focus:ring-[#00A6A6]/10 outline-none transition-all text-right"
 />
 {value && (
 <button
 onClick={() => onChange('')}
