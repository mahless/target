...
const Header: React.FC<HeaderProps> = React.memo(({ toggleSidebar, branch, date, username, pageTitle, branches = [], userRole = '', onBranchChange }) => {
 ...
 return (
 <header className="bg-[#01404E] h-14 shadow-[0_4px_20px_rgba(0,0,0,0.2)] flex items-center justify-between px-4 sticky top-0 z-[100] text-white border-b border-white/5">
 ...
 <h2 className="text-[10px] sm:text-sm md:text-lg font-black text-white truncate max-w-[150px] sm:max-w-none">
